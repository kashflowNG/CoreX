...
The core change involves adding `testConnection` import from `./db` and calling `testConnection` within the server's `listen` callback, logging a warning if the connection fails.
